...
// SendWithSSL send mail
func SendWithSSL(smtpAddress string, port int, username, password string, message *Message) error {
	return send(smtpAddress, port, username, password, true, message)
}
